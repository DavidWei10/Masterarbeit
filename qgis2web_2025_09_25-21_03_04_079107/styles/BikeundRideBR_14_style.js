...
var style_BikeundRideBR_14 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if ("" !== null) {
        ...
        function rules_BikeundRideBR_14(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (exp_BikeundRideBR_14rule0_eval_expression(context)) {
        ...
        var style = rules_BikeundRideBR_14(feature, value);
        ;
