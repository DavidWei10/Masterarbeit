...
function exp_park_ridePoint_3rule3_eval_expression(context) {
    ...
    if (feature.properties) {
        return (((feature.get('Park_Ladem')  == 1) || (feature.get('Park_Ladem')  == 2)) || (feature.get('Park_Ladem')  == 4));
    } else {
        return (((feature.get('Park_Ladem')  == 1) || (feature.get('Park_Ladem')  == 2)) || (feature.get('Park_Ladem')  == 4));
    }
}
...
function exp_park_ridePoint_3rule4_eval_expression(context) {
    ...
    if (feature.properties) {
        return (((feature.get('Carsh_Park')  == 1) || (feature.get('Carsh_Park')  == 2)) || (feature.get('Carsh_Park')  == 3));
    } else {
        return (((feature.get('Carsh_Park')  == 1) || (feature.get('Carsh_Park')  == 2)) || (feature.get('Carsh_Park')  == 3));
    }
}
